...
aligned_latent_dynamics = np.load(
    'E:\MSc Project\code/2022-preserved-dynamics-main\monkey\TaoLiu/result/cognitive/target/'
    'cog_prefrontal8A_target_latent_dynamics_aligned_0.03_30_drift.npy',allow_pickle=True)
colors = get_colors(2)
fig1 = plt.figure(1)
...
# fig3.show()
fig1.savefig(
    'E:\MSc Project\code/2022-preserved-dynamics-main\monkey\TaoLiu/result/figure/monkeyB_cognitive-target-aligned-0.03-drift-example.eps',
    format='eps', dpi=1000)
fig2.savefig(
    'E:\MSc Project\code/2022-preserved-dynamics-main\monkey\TaoLiu/result/figure/monkeyK_cognitive-target-aligned-0.03-drift-example.eps',
    format='eps', dpi=1000)
fig3.savefig(
    'E:\MSc Project\code/2022-preserved-dynamics-main\monkey\TaoLiu/result/figure/monkeyL_cognitive-target-aligned-0.03-drift-example.eps',
    format='eps', dpi=1000)
fig1.clf()
fig2.clf()
fig3.clf()
...
unaligned_latent_dynamics = np.load(
    'E:\MSc Project\code/2022-preserved-dynamics-main\monkey\TaoLiu/result/cognitive/target/'
    'cog_prefrontal8A_target_latent_dynamics_unaligned_0.03_30_drift.npy',allow_pickle=True)
colors = get_colors(2)
fig1 = plt.figure(1)
ax1 = plt.axes(projection='3d', fc='None')
fig2 = plt.figure(2)
...
# fig3.show()
fig1.savefig(
    'E:\MSc Project\code/2022-preserved-dynamics-main\monkey\TaoLiu/result/figure/monkeyB_cognitive-target-unaligned-0.03-drift-example.eps',
    format='eps', dpi=1000)
fig2.savefig(
    'E:\MSc Project\code/2022-preserved-dynamics-main\monkey\TaoLiu/result/figure/monkeyK_cognitive-target-unaligned-0.03-drift-example.eps',
    format='eps', dpi=1000)
fig3.savefig(
    'E:\MSc Project\code/2022-preserved-dynamics-main\monkey\TaoLiu/result/figure/monkeyL_cognitive-target-unaligned-0.03-drift-example.eps',
    format='eps', dpi=1000)
fig1.clf()
fig2.clf()
fig3.clf()
...
aligned_latent_dynamics = np.load(
    'E:\MSc Project\code/2022-preserved-dynamics-main\monkey\TaoLiu/result/cognitive/target/'
    'cog_prefrontal8A_target_latent_dynamics_aligned_0.03_30_drift_2subj.npy',allow_pickle=True)
colors = get_colors(2)
fig1 = plt.figure(1)
ax1 = plt.axes(projection='3d', fc='None')
fig2 = plt.figure(2)
...
fig1.savefig(
    ...
    'monkeyB_cognitive-target-aligned-0.03-drift-BK-example.eps',format='eps', dpi=1000)
fig2.savefig(
    'E:\MSc Project\code/2022-preserved-dynamics-main\monkey\TaoLiu/result/figure/'
    'monkeyK_cognitive-target-aligned-0.03-drift-BK-example.eps',format='eps', dpi=1000)
fig3.savefig(
    'E:\MSc Project\code/2022-preserved-dynamics-main\monkey\TaoLiu/result/figure/'
    'monkeyB_cognitive-target-aligned-0.03-drift-BL-example.eps',format='eps', dpi=1000)
fig4.savefig(
    'E:\MSc Project\code/2022-preserved-dynamics-main\monkey\TaoLiu/result/figure/'
    'monkeyL_cognitive-target-aligned-0.03-drift-BL-example.eps',format='eps', dpi=1000)
fig5.savefig(
    'E:\MSc Project\code/2022-preserved-dynamics-main\monkey\TaoLiu/result/figure/'
    'monkeyK_cognitive-target-aligned-0.03-drift-KL-example.eps',format='eps', dpi=1000)
fig6.savefig(
    'E:\MSc Project\code/2022-preserved-dynamics-main\monkey\TaoLiu/result/figure/'
    'monkeyL_cognitive-target-aligned-0.03-drift-KL-example.eps',format='eps', dpi=1000)
fig1.clf()
fig2.clf()
fig3.clf()
fig4.clf()
...
# classification results of delay and target periods (change file name when analyzing different periods)
with open('E:\MSc Project\code/2022-preserved-dynamics-main\monkey\TaoLiu/result/cognitive/target/'
          'cognitive_prefrontal8A_target_cls_scores_set_0.03_30_drift_delay.pickle', 'rb') as f:
    cls_scores_aligned = pickle.load(f)
with open('E:\MSc Project\code/2022-preserved-dynamics-main\monkey\TaoLiu/result/cognitive/target/'
          'cognitive_prefrontal8A_target_cls_scores_set_unaligned_0.03_30_drift_delay.pickle', 'rb') as f:
    cls_scores_unaligned = pickle.load(f)
with open('E:\MSc Project\code/2022-preserved-dynamics-main\monkey\TaoLiu/result/cognitive/target/'
          'cognitive_prefrontal8A_target_cls_scores_set_within_0.03_30_drift_delay.pickle', 'rb') as f:
...
for pairNum in range(len(cls_scores_aligned)):
    cls_scores[0].append(np.mean(np.array(cls_scores_unaligned[pairNum][3]),1)) # results of each group
...
avg_cls_scores[0].append(np.mean(np.array(cls_scores[0]),0)) # averaged results of classifiers trained on each monkey
...
ax.set_title('GCCA target delay',fontsize=20)
ax.set_xticks(x)
...
plt.ylim([0,1])
plt.savefig(
    'E:\MSc Project\code/2022-preserved-dynamics-main\monkey\TaoLiu/result/figure/cog-cls-target-sep-classifier-0.03-delay.eps',
    format='eps', dpi=1000)
plt.clf()
plt.close()
...
###########################################################################################################################
# 2subj (change file name when analyzing different periods)
with open('E:\MSc Project\code/2022-preserved-dynamics-main\monkey\TaoLiu/result/cognitive/target/'
          'cognitive_prefrontal8A_target_cls_scores_set_0.03_30_drift_delay_2subj.pickle', 'rb') as f:
    aligned_cls_scores = pickle.load(f)
with open('E:\MSc Project\code/2022-preserved-dynamics-main\monkey\TaoLiu/result/cognitive/target/'
          'cognitive_prefrontal8A_target_cls_scores_set_unaligned_0.03_30_drift_delay.pickle', 'rb') as f:
    unaligned_cls_scores = pickle.load(f)
with open('E:\MSc Project\code/2022-preserved-dynamics-main\monkey\TaoLiu/result/cognitive/target/'
          'cognitive_prefrontal8A_target_cls_scores_set_within_0.03_30_drift_delay_2subj.pickle', 'rb') as f:
...
plt.ylim([0,1])
ax.set_ylabel('Accuracy',fontsize=20)
ax.set_title('CCA target delay',fontsize=20)
ax.set_xticks(x)
ax.set_xticklabels(x_label,rotation=30,fontsize=20)
ax.tick_params(axis='y', labelsize=20)
ax.legend(loc='upper left',fontsize=15)
plt.savefig(
    'E:\MSc Project\code/2022-preserved-dynamics-main\monkey\TaoLiu/result/figure/cog-cls-target-sep-classifier-0.03-delay-2subj.eps',
    format='eps', dpi=1000)
plt.clf()
plt.close()


# GCCA score (change file name when analyzing different periods)
from tools import utilityTools as utility
aligned_GCCA_score = np.load(
    'E:\MSc Project\code/2022-preserved-dynamics-main\monkey\TaoLiu/result/cognitive/target/'
    'cog_prefrontal8A_target_GCCA_score_aligned_0.03_30_drift.npy',allow_pickle=True)
unaligned_GCCA_score = np.load(
    'E:\MSc Project\code/2022-preserved-dynamics-main\monkey\TaoLiu/result/cognitive/target/'
    'cog_prefrontal8A_target_corr_score_unaligned_0.03_30_drift.npy',allow_pickle=True)
withinsub_GCCA_score = np.load(
    'E:\MSc Project\code/2022-preserved-dynamics-main\monkey\TaoLiu/result/cognitive/target/'
    'cog_prefrontal8A_target_GCCA_score_withinsub_0.03_30_drift.npy',allow_pickle=True)
aligned_score = []
unaligned_score = []
...
# only showing the top 10 components
fig,ax = plt.subplots(ncols=1,dpi=300)
...
ax.set_title('Target GCCA score of components',fontdict={'size':15})
ax.legend(fontsize=10)
ax.set_ylabel('Correlation',fontdict={'size':15})
fig.tight_layout()
plt.savefig(
    'E:\MSc Project\code/2022-preserved-dynamics-main\monkey\TaoLiu/result/figure/cog-target-component-score-drift-0.03-10.eps',
    format='eps', dpi=1000)
plt.clf()
plt.close()
...
########################################################################################################################
# CCA score (change file name when analyzing different periods)
from tools import utilityTools as utility
aligned_CCA_score = np.load(
    'E:\MSc Project\code/2022-preserved-dynamics-main\monkey\TaoLiu/result/cognitive/target/'
    'cog_prefrontal8A_target_CCA_score_aligned_0.03_30_drift_2subj.npy',allow_pickle=True)
unaligned_CCA_score = np.load(
    'E:\MSc Project\code/2022-preserved-dynamics-main\monkey\TaoLiu/result/cognitive/target/'
    'cog_prefrontal8A_target_corr_score_unaligned_0.03_30_drift.npy',allow_pickle=True)
withinsub_CCA_score = np.load(
    'E:\MSc Project\code/2022-preserved-dynamics-main\monkey\TaoLiu/result/cognitive/target/'
    'cog_prefrontal8A_target_CCA_score_withinsub_0.03_30_drift_2subj.npy',allow_pickle=True)
aligned_score = []
unaligned_score = []
...
ax.set_xlim([.5,10+.5])
ax.set_xlabel('Component order',fontdict={'size':15})
ax.set_title('Target CCA score of components',fontdict={'size':15})
ax.legend(fontsize=10)
ax.set_ylabel('Correlation',fontdict={'size':15})
fig.tight_layout()
plt.savefig(
    'E:\MSc Project\code/2022-preserved-dynamics-main\monkey\TaoLiu/result/figure/cog-target-component-score-drift-0.03-2subj-10.eps',
    format='eps', dpi=1000)
plt.clf()
plt.close()
...
# VAF (change file name when analyzing different periods)
from tools import utilityTools as utility
VAF = np.load('E:\MSc Project\code/2022-preserved-dynamics-main\monkey\TaoLiu/result\cognitive/target/'
              'cog_prefrontal8A_target_VAF_0.03_30_drift.npy',allow_pickle=True)
...
fig1.savefig(
    'E:\MSc Project\code/2022-preserved-dynamics-main\monkey\TaoLiu/result/figure/monkeyB_cognitive-target-PCA-VAF-0.03.eps',
    format='eps', dpi=1000)
fig2.savefig(
    'E:\MSc Project\code/2022-preserved-dynamics-main\monkey\TaoLiu/result/figure/monkeyK_cognitive-target-PCA-VAF-0.03.eps',
    format='eps', dpi=1000)
fig3.savefig(
    'E:\MSc Project\code/2022-preserved-dynamics-main\monkey\TaoLiu/result/figure/monkeyL_cognitive-target-PCA-VAF-0.03.eps',
    format='eps', dpi=1000)
fig1.clf()
fig2.clf()
fig3.clf()
...
# VAF-cc (change file name when analyzing different periods, noting that this part of code is not used for the report)
from tools import utilityTools as utility
VAF_cc = np.load('E:\MSc Project\code/2022-preserved-dynamics-main\monkey\TaoLiu/result\cognitive/target/'
                 'cog_prefrontal8A_target_VAF_cc_0.4_100_drift.npy',allow_pickle=True)
...
fig1.savefig(
    'E:\MSc Project\code/2022-preserved-dynamics-main\monkey\TaoLiu/result/figure/monkeyB_cognitive-target-CCA-VAF.eps',
    format='eps', dpi=1000)
fig2.savefig(
    'E:\MSc Project\code/2022-preserved-dynamics-main\monkey\TaoLiu/result/figure/monkeyK_cognitive-target-CCA-VAF.eps',
    format='eps', dpi=1000)
fig3.savefig(
    'E:\MSc Project\code/2022-preserved-dynamics-main\monkey\TaoLiu/result/figure/monkeyL_cognitive-target-CCA-VAF.eps',
    format='eps', dpi=1000)
fig1.clf()
fig2.clf()
fig3.clf()
