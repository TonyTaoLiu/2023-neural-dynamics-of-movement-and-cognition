...
for ii in range(1):
    ...
    for id1,id2,testList in pairIndex_uni:
        ...
        for testId, _ in enumerate(testList):
            ...
            X2_aligned = X2 @ gcca.weights[1][:,:outdim_size] @ linalg.inv(gcca.weights[0])
            X3_aligned = X3 @ gcca.weights[2][:,:outdim_size] @ linalg.inv(gcca.weights[0])
...
np.save('E:\MSc Project\code/2022-preserved-dynamics-main\monkey\TaoLiu/result/motor_M1_cls_scores_set_withinsub_nohist.npy',cls_scores_set)
file = open('E:\MSc Project\code/2022-preserved-dynamics-main\monkey\TaoLiu/result/motor_M1_cls_scores_set_withinsub_nohist.txt','w')
