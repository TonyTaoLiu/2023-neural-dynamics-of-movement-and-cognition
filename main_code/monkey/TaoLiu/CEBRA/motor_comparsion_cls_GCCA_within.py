...
for ii in range(1):
    ...
    for id1,id2,testList in pairIndex_uni:
        ...
        for testId, _ in enumerate(testList):
            ...
            gcca.fit([X1, X2, X3]) # align across 3 sessions
...
np.save('E:\MSc Project\code/2022-preserved-dynamics-main\monkey\TaoLiu/result/motor_M1_cls_scores_set_withinsub_CEBRA_compare_GCCA.npy',cls_scores_set)
file = open('E:\MSc Project\code/2022-preserved-dynamics-main\monkey\TaoLiu/result/motor_M1_cls_scores_set_withinsub_CEBRA_compare_GCCA.txt','w')
