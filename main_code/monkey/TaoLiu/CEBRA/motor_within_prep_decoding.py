...
for ii in range(1):
    ...
    for id1,id2,testList in pairIndex_uni:
        ...
        for testId, _ in enumerate(testList):
            ...
            gcca.fit([X1, X2, X3]) # align across sessions
            ...
            # test the decoder
            scores.append(classifier1.score(X2_test, Y2_test)) # test classifier
...
np.save('E:\MSc Project\code/2022-preserved-dynamics-main\monkey\TaoLiu/result/motor_M1_cls_scores_set_within_prep_nohist.npy',cls_scores_set)
file = open('E:\MSc Project\code/2022-preserved-dynamics-main\monkey\TaoLiu/result/motor_M1_cls_scores_set_within_prep_nohist.txt','w')
