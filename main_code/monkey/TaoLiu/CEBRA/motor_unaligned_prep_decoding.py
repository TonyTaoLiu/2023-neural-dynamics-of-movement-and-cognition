...
for ii in range(1):
    ...
    for id1,id2,testList in pairIndex_uni:
        ...
        for testId, _ in enumerate(testList):
            ...
            X1_unaligned = X1.reshape((-1, n_time1 * n_comp))
            X2_unaligned = X2.reshape((-1, n_time1 * n_comp))
            X3_unaligned = X3.reshape((-1, n_time1 * n_comp))
            ...
            X3_test, Y3_test = X3_unaligned[trial_index1, :], AllTar1[trial_index1]
...
np.save('E:\MSc Project\code/2022-preserved-dynamics-main\monkey\TaoLiu/result/motor_M1_cls_scores_set_unaligned_prep_nohist.npy',cls_scores_set)
file = open('E:\MSc Project\code/2022-preserved-dynamics-main\monkey\TaoLiu/result/motor_M1_cls_scores_set_unaligned_prep_nohist.txt','w')
