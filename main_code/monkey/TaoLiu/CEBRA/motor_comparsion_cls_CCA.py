...
# np.save('E:\MSc Project\code/2022-preserved-dynamics-main\monkey\TaoLiu/result/motor_M1_cls_scores_set_CEBRA_compare_CCA.npy',cls_scores_set)
# file = open('E:\MSc Project\code/2022-preserved-dynamics-main\monkey\TaoLiu/result/motor_M1_cls_scores_set_CEBRA_compare_CCA.txt','w')
# for fp in cls_scores_set:
#     file.write(str(fp))
#     file.write('\n')
# file.close()

np.save('E:\MSc Project\code/2022-preserved-dynamics-main\monkey\TaoLiu/result/motor_M1_cls_scores_set_prep_nohist_2subj.npy',cls_scores_set)
file = open('E:\MSc Project\code/2022-preserved-dynamics-main\monkey\TaoLiu/result/motor_M1_cls_scores_set_prep_nohist_2subj.txt','w')
for fp in cls_scores_set:
    file.write(str(fp))
    file.write('\n')
file.close()