...
allDFs,full_list,n_shared_trial,target_num,n_timepoints = load_data(data_path,file_name,84,100) # cue: 50-66; target: 117-133
    ...
    for id2 in pairIndex_uni[1]:
        for id3 in pairIndex_uni[2]:
            ...
            with open('E:\MSc Project\code/2022-preserved-dynamics-main\monkey\TaoLiu\CEBRA/result'
                      '\cognitive/cog_latent_dynamics_target_aligned_pca30_full_3d_delay' + str(num) + '.pickle', 'wb') as f:
                pickle.dump(latent_dynamics_full, f) # running this code takes long time, saving at each group allows pause
            ...
            # change with your own saving path
            with open('E:\MSc Project\code/2022-preserved-dynamics-main\monkey\TaoLiu\CEBRA/result'
                      '\cognitive/cog_latent_dynamics_target_aligned_pca30_full_reshape_3d_delay' + str(num) + '.pickle', 'wb') as f:
