...
for ii in range(1):
    ...
    for id1,id2,testList in pairIndex_uni:
        ...
        tcca_reg = 1e-08  # initial setting
        outdim_size = n_comp
...
np.save('E:\MSc Project\code/2022-preserved-dynamics-main\monkey\TaoLiu/result/motor_M1_cls_scores_set_withinsub_prep_2subj.npy',cls_scores_set)
file = open('E:\MSc Project\code/2022-preserved-dynamics-main\monkey\TaoLiu/result/motor_M1_cls_scores_set_withinsub_prep_2subj.txt','w')
