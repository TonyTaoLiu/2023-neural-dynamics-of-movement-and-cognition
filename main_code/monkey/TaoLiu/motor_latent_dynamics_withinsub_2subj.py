...
for id1,id2,testList in pairIndex_uni:
    ...
    for testId, _ in enumerate(testList):
        ...
        CCA_score.append((id1, id2, testList[testId], [r1, r2, r3]))
        ...
        alltar_latent_dynamics.append(
            (id1, id2, testList[testId], [[ex0_all1, ex1_all1], [ex0_all2, ex2_all1], [ex1_all2, ex2_all2]]))
        for tar in range(8):
            ...
            ex1_2 = ex1 @ U4 @ Vh4
            ex2_2 = ex2 @ U5 @ Vh5
            latent_dynamics.append((id1, id2, testList[testId], tar, [[ex0_1, ex1_1], [ex0_2, ex2_1], [ex1_2, ex2_2]]))
        print('pair '+str(num)+' done')
        num += 1
# change with your own saving path
np.save('E:\MSc Project\code/2022-preserved-dynamics-main\monkey\TaoLiu/result/motor_M1_withinsub_latent_dynamics_2subj.npy',latent_dynamics)
np.save('E:\MSc Project\code/2022-preserved-dynamics-main\monkey\TaoLiu/result/motor_M1_alltar_withinsub_latent_dynamics_2subj.npy',alltar_latent_dynamics)
np.save('E:\MSc Project\code/2022-preserved-dynamics-main\monkey\TaoLiu/result/motor_MCx_withinsub_CCA_score_2subj.npy',CCA_score)
